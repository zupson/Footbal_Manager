    ...
    public partial class PlayerControl : UserControl
    {
        ...
        public void SetPlayerData(Player player)
        {
            ...
            if (!string.IsNullOrEmpty(player.ImagePath))
            {
                ...
                //string fullImagePath = Path.Combine(baseDir, LocalPaths.ParentFolder, LocalPaths.PlayersDir, LocalPaths.ImagesDir, player.ImagePath);
                //Console.WriteLine("Full image path: " + fullImagePath);

                string imageFileName = $"{player.Name}_{player.ShirtNumber}.png";

                string filePath = FileUtility.GetFilePath(imageFileName);
        ...
        private void RemovePicture_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            string filePath = FileUtility.GetFilePath("NoImage.png");
